   ...
   (quote
    (("Aegean Numbers"
     ...
     ("Alphabetic Presentation Forms"
      ("DejaVu Sans:width=condensed" "Arial Unicode MS" "Cardo" "Quivira" "FreeMono"))
     ("Ancient Greek Musical Notation"
      ("Musica" "Aegean" "Cardo" "Symbola" "Quivira"))
     ("Ancient Greek Numbers"
      ("Apple Symbols" "Cardo" "Aegean" "Quivira"))
     ("Ancient Symbols"
      ("Cardo" "Analecta" "Aegean" "Quivira"))
     ...
     ("Arabic Presentation Forms-B"
      ("DejaVu Sans Mono" "Geeza Pro" "Adobe Arabic" "Arial Unicode MS" "Microsoft Sans Serif" "Kufi Standard GK" "DejaVu Sans:width=condensed" "FreeMono" "DecoType Naskh"))
     ("Arabic Supplement"
     ...
     ("Arabic"
      ("Courier New" "Simplified Arabic Fixed" "Simplified Arabic" "Adobe Arabic" "Geeza Pro" "Baghdad" "Damascus" "Al Bayan" "Andalus" "Arabic Typesetting" "Traditional Arabic" "Scheherazade" "DejaVu Sans Mono" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Nadeem" "Tahoma" "Microsoft Sans Serif" "MPH 2B Damase" "Kufi Standard GK" "DecoType Naskh" "Koodak" "FreeMono"))
     ("Armenian"
      ("Mshtakan" "Sylfaen" "DejaVu Sans:width=condensed" "Quivira" "MPH 2B Damase" "Arial Unicode MS" "FreeMono"))
     ("Arrows"
      ("DejaVu Sans Mono" "Apple Symbols" "Cambria Math" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Symbola" "Quivira" "FreeMono"))
     ("Avestan"
      ("Ahuramzda"))
     ("Balinese"
      ("Aksara Bali"))
     ...
     ("Block Elements"
      ("DejaVu Sans Mono" "FreeMono" "DejaVu Sans:width=condensed" "Apple Symbols" "Symbola" "Quivira"))
     ("Bopomofo Extended"
     ...
     ("Box Drawing"
      ("DejaVu Sans Mono" "FreeMono" "DejaVu Sans" "Symbola" "Quivira"))
     ("Brahmi"
      ("Adinatha Tamil Brahmi"))
     ("Braille Patterns"
      ("Quivira" "DejaVu Sans:width=condensed" "Apple Symbols" "Symbola" "FreeMono"))
     ("Buginese"
      ("MPH 2B Damase"))
     ("Buhid"
      ("Quivira"))
     ...
     ("Cham"
      ("Code2000"))
     ("Cherokee"
      ("Plantagenet Cherokee" "MPH 2B Damase" "Quivira" "FreeMono"))
     ...
     ("Cuneiform"
      ("Akkadian"))
     ("Currency Symbols"
      ("Monaco" "Consolas" "DejaVu Sans Mono" "DejaVu Sans:width=condensed" "Noto Sans" "Apple Symbols" "Symbola" "Quivira" "FreeMono"))
     ("Cypriot Syllabary"
      ("Aegean" "Code2001"))
     ("Cyrillic Extended-A"
      ("Quivira"))
     ("Cyrillic Extended-B"
      ("Quivira"))
     ("Cyrillic Supplement"
      ("Consolas" "Courier New" "Calibri" "Noto Sans" "DejaVu Sans:width=condensed" "Doulos SIL" "Symbola" "Quivira"))
     ("Cyrillic"
      ("Consolas" "Monaco" "DejaVu Sans Mono" "DejaVu Sans:width=condensed" "Noto Sans" "Courier New" "Calibri" "Microsoft Sans Serif" "Code2000" "Arial Unicode MS" "Doulos SIL" "Symbola" "FreeMono" "Charcoal CY" "Geneva CY"))
     ("Deseret"
     ...
     ("Dingbats"
      ("Apple Color Emoji" "DejaVu Sans Mono" "Zapf Dingbats" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Code2000" "Symbola" "Quivira"))
     ("Domino Tiles"
     ...
     ("Enclosed Alphanumerics"
      ("Junicode" "Arial Unicode MS" "Quivira" "Code2000" "BabelStone Han" "WenQuanYi Zen Hei Mono"))
     ...
     ("General Punctuation"
      ("Monaco" "Apple Symbols" "Cambria Math" "DejaVu Sans:width=condensed" "Symbola" "Quivira" "FreeMono"))
     ("Geometric Shapes"
      ("DejaVu Sans Mono" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Symbola" "Quivira" "FreeMono"))
     ("Georgian Supplement"
     ...
     ("Gothic"
      ("Analecta" "Junicode" "MPH 2B Damase" "FreeSerif" "Code2001" "Quivira"))
     ("Greek Extended"
      ("DejaVu Sans Mono" "Gentium Plus Compact" "Gentium Plus" "Consolas" "Courier New" "Noto Sans" "DejaVu Sans:width=condensed" "Cardo" "Junicode" "Microsoft Sans Serif" "Arial Unicode MS" "Arial" "Tahoma" "Doulos SIL" "Aegean" "Quivira" "FreeMono"))
     ("Greek and Coptic"
      ("DejaVu Sans Mono" "Gentium Plus Compact" "Gentium Plus" "Consolas" "DejaVu Sans:width=condensed" "Noto Sans" "Calibri" "Microsoft Sans Serif" "Lucida Console" "Arial Unicode MS" "Cardo" "Aegean" "Symbola" "Quivira"))
     ("Gujarati"
     ...
     ("Hanunoo"
      ("MPH 2B Damase" "Quivira"))
     ("Hebrew"
      ("Miriam Fixed" "Arial Hebrew" "Raanana" "New Peninim MT" "Aharoni" "David" "FrankRuehl" "Gisha" "Levenim MT" "Narkisim" "Rod" "Cardo" "Courier New" "Adobe Hebrew" "Microsoft Sans Serif" "Tahoma" "Lucida Sans Unicode" "Arial Unicode MS" "Arial" "Quivira"))
     ("Hiragana"
      ("Osaka:spacing=m" "MS Gothic" "MS Mincho" "MingLiU" "Hiragino Kaku Gothic Pro" "Meiryo" "Arial Unicode MS" "HanaMinA" "BabelStone Han"))
     ("IPA Extensions"
      ("Monaco" "Consolas" "DejaVu Sans Mono" "Courier New" "Noto Sans" "Arial Unicode MS" "Arial" "Tahoma" "Microsoft Sans Serif" "Cardo" "Symbola" "Quivira" "FreeMono"))
     ...
     ("Latin Extended-C"
      ("DejaVu Sans:width=condensed" "Noto Sans" "Cambria Math" "Quivira"))
     ("Latin Extended-D"
      ("FreeMono" "DejaVu Sans Mono" "DejaVu Sans:width=condensed" "Junicode" "Cardo" "Quivira" "Code2000"))
     ("Lepcha"
      ("Mingzat"))
     ("Letterlike Symbols"
     ...
     ("Linear B Syllabary"
      ("Aegean" "Code2001"))
     ("Lisu"
      ("Miao Unicode" "Lisu Unicode" "Quivira"))
     ("Lycian"
      ("Aegean" "Quivira"))
     ("Lydian"
      ("Aegean" "Quivira"))
     ...
     ("Mathematical Operators"
      ("Everson Mono" "DejaVu Sans Mono" "Apple Symbols" "Cambria Math" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Code2000" "Quivira" "Symbola" "FreeMono"))
     ("Meetei Mayek"
     ...
     ("Ol Chiki"
      ("Code2000"))
     ("Old Italic"
      ("DejaVu Sans:width=condensed" "Cardo" "Code2001" "Aegean" "Quivira" "FreeMono"))
     ("Old Persian"
      ("Aegean" "Code2001"))
     ("Old South Arabian"
      ("Qataban" "Quivira"))
     ...
     ("Rejang"
      ("Code2000"))
     ("Runic"
      ("Junicode" "FreeMono" "Quivira" "Cardo"))
     ("Samaritan"
      ("Quivira"))
     ("Saurashtra"
      ("Code2000" "Sourashtra"))
